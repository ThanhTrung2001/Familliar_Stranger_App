...
class Rounded_Border_Dialog_Button extends StatelessWidget {
  final String text;
  final double horizon, verti;
  final Color bordercolor, textcolor;
  final VoidCallback press;
  const Rounded_Border_Dialog_Button({
    Key? key,
    required this.text,
    ...
    return Container(
      child: ClipRRect(
        ...
        child: TextButton(
          ...
          onPressed: press,
          child: Text(text ,style: TextStyle(fontFamily: 'ZenDots',color: textcolor, fontWeight: FontWeight.bold, fontSize: 18,),),
        ),
      ),
    );
  }
