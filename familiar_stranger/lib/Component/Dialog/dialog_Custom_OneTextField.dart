    ...
    return Dialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border:
              Border.all(width: 5.0, color: Color.fromARGB(255, 99, 53, 156)),
          ...
          child: Column(
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  "Enter that friend's UID :",
                  style: TextStyle(
                      fontFamily: 'ZenDots', fontSize: 20, color: Main_Text),
